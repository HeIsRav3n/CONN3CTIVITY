                ...
                <div className="px-6 py-6 flex flex-col gap-5">
                  ...
                  {user ? (
                    <div className="flex flex-col gap-3 pt-2 border-t border-white/10">
                      ...
                      >
                        <img
                          src={user.avatar_url || `https://cdn.discordapp.com/avatars/${user.id}/${user.avatar}.png`}
                          alt=""
                          className="w-8 h-8 rounded-full border border-[#C9A96E]/40 object-cover"
                        />
                        <span
                          style={{
                            fontFamily: "'Josefin Sans', sans-serif",
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white py-3 rounded-sm transition-colors"
                      style={{
                        fontFamily: "'Josefin Sans', sans-serif",
                        fontWeight: 600,
                        fontSize: '0.7rem',
